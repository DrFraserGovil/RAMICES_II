...
{
	output << "Time, Radius, StarMassFormed, StarsFormed, CCSN_Events, AGB_Deaths, NSM_Events, SNIa_Events, ECSN_Events, ";
	output << "BirthRate, CCSNRate, AGBRate, NSMRate, SNIaRate, ECSNRate\n";
}
void StarEvents::Save(std::stringstream &output, double timestep)
{
	output << StarMassFormed << ", " << NStarsFormed << ", " << CCSN << ", " << AGBDeaths << ", " << NSM << ", " << SNIa << ", " << ECSN << ", ";
