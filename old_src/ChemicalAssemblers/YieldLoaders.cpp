...
void YieldGrid::LoadMarigoYields()
{
	...
	{		
		...
		std::string fileName = Opts->Simulation.Resources + "ChemicalData/MarigoYields/totyieldsz0";
		if (fileZ < 0.01)
		{
			fileName += "0";
		}
...
void YieldGrid::LoadOrfeoYields()
{
	...
	{
		int m = masses[i];
		std::string fileName = Opts->Simulation.Resources + "ChemicalData/OriginalOrfeo/z22m";
...
void YieldGrid::LoadLimongiYields()
{
	...
	std::string fileName =  Opts->Simulation.Resources +"ChemicalData/LimoChiefYields.dat";
...
void YieldGrid::LoadMaederYields()
{
	...
	std::string fileName =  Opts->Simulation.Resources +"ChemicalData/MaederYields.dat";
