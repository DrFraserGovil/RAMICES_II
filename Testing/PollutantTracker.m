...
files = "../Output/Pollute_" + ["NoStars"] + "/Enrichment_Absolute_ColdGas.dat";
...
times = round([2.^linspace(log2(0.1),log2(9),6)],2,'significant');
...
%         focus(1:3,:)
        ...
        hold on;
        plot(focus.RingRadius,focus.Total_Eu/1e-10);
        hold off;
        set(gca,'yscale','log')
        xlim([0,20]);
        ylim([1e-7,1]);
